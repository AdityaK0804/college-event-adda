    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="mb-8">
          ...
          <p className="text-gray-600">Discover events happening at Crescent and beyond</p>
        </header>
        ...
        {hasFilters && (
          <div className="flex flex-wrap gap-2 mb-6">
            {selectedCategory && (
              <Badge className="bg-eventx-light-purple text-eventx-purple cursor-pointer" onClick={() => handleCategoryChange("all")}>
                {selectedCategory} ×
              </Badge>
            )}
            {priceRange && (
              <Badge className="bg-eventx-light-purple text-eventx-purple cursor-pointer" onClick={() => setPriceRange("")}>
                {priceRange === "free" ? "Free" : priceRange === "under500" ? "Under ₹500" : priceRange === "500to1000" ? "₹500–₹1000" : "Above ₹1000"} ×
              </Badge>
            )}
            {debouncedSearch && (
              <Badge className="bg-eventx-light-purple text-eventx-purple cursor-pointer" onClick={() => setSearchTerm("")}>
                "{debouncedSearch}" ×
              </Badge>
            )}
          </div>
        ...
        {isError ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">Could not load events. Please try again.</p>
